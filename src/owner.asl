...
dailyPayment(50). //The amout the owner pays to the robot every day (only if robot asks for money)
pensionPayout(500). //The amount the owner receives from each of his multiple pensions.
